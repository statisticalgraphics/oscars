...
all_actors_filter <- all_actors_temp %>% filter(Freq > 4)
...
theme_oscars = function(base_size = 12, grid_width = 0.2) {
  ...
  theme_bw(base_size) +
    theme(
          ...
          panel.grid.major = element_line(colour = "black", size = grid_width),
          panel.grid.minor = element_line(colour = "black", size = grid_width),
